...
import time
import shutil
from absl import app #flags, app
import logging
...
def main(argv):
  ...
  # num_train_steps = int(len(train_examples) / TRAIN_BATCH_SIZE * NUM_TRAIN_EPOCHS) # default: 84
  num_train_steps = mltunerUtil.get_trial_budget()
  if num_train_steps is None:
    num_train_steps = 84 # default values
...
if __name__ == '__main__':
  ...
  flags.DEFINE_bool(
          'get_model', False, 'if True,will record model in networkx json format in file. if False,train the model.')
  flags.DEFINE_string(
